...
class ContactData {
  ...
  String avatarUrl;
  //构造函数
  ContactData ({@required this.seationKey,this.name,this.avatarUrl});
}
//好友数据集
List<ContactData > contactData = [
  ...
  ContactData(
      ...
      avatarUrl:
      ''),
  ContactData(seationKey: 'L', name: '联通', avatarUrl: ''),
  ContactData(
      seationKey: 'L',
      name: '留学生',
  ...
  ContactData(
      ...
      name: '老司机',
      avatarUrl:
      'http://www.qqzhi.com/uploadpic/2014-10-14/001343706.jpg'),
  ContactData(
      seationKey: 'L',
      name: '辣眼睛',
      avatarUrl:
      ''),
  ContactData(seationKey: 'M', name: 'Mary', avatarUrl: ''),
  ContactData(
      seationKey: 'M',
      name: 'Master',
      avatarUrl:
      ''),
  ContactData(seationKey: 'P', name: '彭于晏', avatarUrl: ''),
  ContactData(
      seationKey: 'P',
      name: '彭简',
      avatarUrl:
  ...
  ContactData(seationKey: 'S', name: '孙丽', avatarUrl: ''),
  ContactData(
      seationKey: 'S',
      name: '沈家',
      avatarUrl:
  ...
  ContactData(seationKey: 'X', name: '小猪', avatarUrl: ''),
  ContactData(
      seationKey: 'X',
      name: '小猪佩奇',
      avatarUrl:
